        ...
        <div className="space-y-6 bg-white p-8 rounded-lg shadow-lg">
          ...
          >
            ...
            <p className="text-sm text-gray-600 italic">
              ...
              carefully before using the https://www.mobiphleb.com website
              (the "service") operated by MobiPhleb ("us", 'we", "our").
            </p>
          </motion.div>
          {sections.map((section: Section, sectionIdx: number) => (
            <div key={sectionIdx}>
              {/* Section Header */}
              <h2 className="text-lg font-bold mt-6 text-gray-900">{section.title}</h2>
